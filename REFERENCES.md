...
- **Poor Charlie's Almanack** - Charlie Munger. The canonical collection of Munger's
  speeches and essays, including the full taxonomy of mental models and the
  latticework approach this skill is built on.
- **Psychology of Human Misjudgment** - Charlie Munger (1995 Harvard speech; expanded
  version in Poor Charlie's Almanack). Source for most of the `Human Nature & Judgment`
  category (~25 cognitive biases and tendencies).
- **Berkshire Hathaway Annual Letters** - Warren Buffett & Charlie Munger.
  https://www.berkshirehathaway.com/letters/letters.html. Decades of worked examples
  applying mental models to real business decisions.
...
- **Seeking Wisdom: From Darwin to Munger** - Peter Bevelin. A structured tour of
  Munger's thinking with extensive citations.
